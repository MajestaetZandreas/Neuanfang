...
public class Level
{
    ...
    public ArrayList<Plattform> erstelleLevel()
    {
        ...
        Plattform plattform01 = new Plattform(plattform_image,030,465,100);
        ...
        Plattform plattform13 = new Plattform(plattform_image,(int) (980*Math.random())+80,(int) (200*Math.random())+80,100);
        Plattform plattform14 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (320*Math.random())+200,100);
        Plattform plattform15 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (440*Math.random())+320,100);
        Plattform plattform16 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (560*Math.random())+440,100);
        Plattform plattform17 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (680*Math.random())+560,100);
        Plattform plattform18 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (800*Math.random())+560,100);
        Plattform plattform19 = new Plattform(plattform_image,(int) (980*Math.random())+100,(int) (920*Math.random())+800,100);
        // Plattform plattform20 = new Plattform(plattform_image,(int) (1160*Math.random())+80,(int) (850*Math.random())+1,100);
        // Plattform plattform21 = new Plattform(plattform_image,(int) (1160*Math.random())+80,(int) (850*Math.random())+1,100);
        // Plattform plattform22 = new Plattform(plattform_image,(int) (1160*Math.random())+80,(int) (850*Math.random())+1,100);
        // Plattform plattform23 = new Plattform(plattform_image,(int) (1160*Math.random())+80,(int) (850*Math.random())+1,100);
        // Plattform plattform24 = new Plattform(plattform_image,(int) (1160*Math.random())+80,(int) (850*Math.random())+1,100);
        // Plattform plattform25 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform26 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform27 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform28 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform29 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform30 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform31 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform32 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform33 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform34 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform35 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform36 = new Plattform(plattform_image,(int) (1160*Math.random())+160,(int) (850*Math.random())+1,100);
        // Plattform plattform37 = new Plattform(plattform_image,(int) (1160*Math.random())+220,(int) (850*Math.random())+1,100);
        // Plattform plattform38 = new Plattform(plattform_image,(int) (1160*Math.random())+220,(int) (850*Math.random())+1,100);
        // Plattform plattform39 = new Plattform(plattform_image,(int) (1160*Math.random())+220,(int) (850*Math.random())+1,100);
